...
import 'screens/category/category_products_screen.dart'; // 🆕 Thêm import category products screen
...
import 'models/category_model.dart'; // 🆕 Thêm import category model
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        ...
        // Handle category products route with CategoryModel argument
